...
(function() {
  ...
  Carousel = (function() {
    ...
    Carousel.prototype.cyclen = function() {
          
              $('.prev').addClass('dis_n');
          var s = function(){
            var stract = $('.preview.active').attr('id');
            var galeryact = +stract.substring(2);
            var lenn = $('.preview').length;
            
              $('.prev').removeClass('dis_n');
            if (galeryact == +lenn-1) {
              $('.next').addClass('dis_n');
            }else{
              $('.next').removeClass('dis_n');
            };
          };
        ...
        /*$('.next, .prev').click(function(){
          ...
          var strn = $('.preview.active').attr('id');
          var galeran = +strn.substring(2);
          var lenn = $('.preview').length;
          if (+galeran<=+lenn) {
        ...
        $('.prev').click(function(){
          var str = $('.preview.active').attr('id');
          var galera = +str.substring(2);
          if (galera<=2) {
            $(this).css('display', 'none');
          };
        });*/
